...
export default function Price() {
    return (
        <div className='container-fluid p-5 text-light' style={{ backgroundColor: '#3c3c3c' }}>
            <div className='row'>
                <div className='col-12 col-sm-12 col-md-12 col-lg-6 p-lg-5'>
                ...
                <div className='col-12 col-sm-12 col-md-12 col-lg-6'>
                    <h3 className='text-center p-2 mt-2 mr-lg-5'>Annual Subscription</h3>
                    <div className='row text-center'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-5 border p-4'>
